<div class="card no-border clearfix mb0">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            <div class="row">
                <label for="re_captcha_site_key"
                    class=" col-md-2"><?php echo app_lang('re_captcha_site_key'); ?></label>
                <div class=" col-md-10">
                    <?php
                    // LINEA 19: PEG A AQUI TU SITE KEY (copia desde Google reCAPTCHA, inicia con 6L...)
        ...
        <div class="form-group">
            <div class="row">
                <label for="re_captcha_secret_key"
                    class=" col-md-2"><?php echo app_lang('re_captcha_secret_key'); ?></label>
                <div class=" col-md-10">

                    <?php
                    // LINEA 36: PEG A AQUI TU SECRET KEY (copia desde Google reCAPTCHA, es privada)
                    echo form_input(array(
